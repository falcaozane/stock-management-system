...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Search a Product */}
      <div className="container mx-auto my-8 border-green-300 border-2 p-5 rounded-xl hover:border-green-400">
        ...
        <div className="flex flex-col sm:flex-row mb-2">
          <input
            ...
            className="flex-1 border border-gray-300 px-4 py-2 rounded-l-md mb-2 sm:mb-0"
          />
          <select
    ...
    <div className="container mx-auto my-8 border-green-300 border-2 p-5 rounded-xl hover:border-green-400">
      ...
      <div className="container my-8 mx-auto border-green-300 border-2 p-5 rounded-xl hover:border-green-500">
              ...
              <table className="table-auto w-full">
                ...
                <tbody>
                  {products.map((product) => (
                    <tr key={product.slug}>
                    <td className="border px-5 py-2">{product.slug}</td>
                    <td className="border px-2 py-2">{product.quantity}</td>
